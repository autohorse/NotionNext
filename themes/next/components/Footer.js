  ...
  return (
        ...
        >
            ...
            <span>
                ...
                {siteConfig('BEI_AN') && <><i className='fas fa-shield-alt' /> 赣ICP备2022003892号 <a href='https://beian.miit.gov.cn/' className='mr-2'>{siteConfig('BEI_AN')}</a><br /></>}
                ...
                <br />
                <h1>{title}</h1>
                <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '>Powered by  <a href='https://blog.rocseo.com' className='underline '>timetowatch {siteConfig('VERSION')}</a>.</span>
            </span>
        </footer>
  )
}
