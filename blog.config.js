...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Paul*拾光', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的IT干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://timetowatch.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '拾光, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@timetowatch.eu.org
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 粤ICP备2022003892号
